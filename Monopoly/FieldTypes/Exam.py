...
QUESTIONS = [
    ...
    "Ако имаме 5 книги и искаме да ги наредим на рафт, има точно 120 различни начина да го направим?",
    "Ако хвърлим монета 10 пъти, винаги ще получим точно 5 пъти ези и 5 пъти тура?",
    ...
    "Алгоритъмът на Дейкстра може да работи с отрицателни тегла в граф?",
    "В Python всички класове наследяват object?",
    "В Python можем да заменим стандартните оператори (+, -, *) чрез методи като __add__()?",
...
EXPLANATIONS = [
    ...
    "Ако функцията е диференцируема, тя задължително е непрекъсната.",
    ...
    "Дейкстра може да даде грешни резултати пир отрицателни числа.",
    ...
    "Garbage collector автоматично освобождава неизползваната памет.",
...
class Exam(Field):
    ...
    def action(self, screen, game):
        ...
        if dec == ANSWERS[question_indx]:
            ...
            decision_menu(game.screen, EXPLANATIONS[question_indx], [["Добре", (300, 370), (150, 50)]], game)
